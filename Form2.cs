    ...
    public partial class Doctor : Form
    {
        ...
        private async void Blink()
        {
            while (true)
            {
                ...
                label2.BackColor = label2.BackColor == Color.Silver ? Color.LightGray : Color.Silver;
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                dbcon.Open();
                str = "SELECT HospitalName, HospitalAddress, Diagnosis, TotalDischarges FROM [Excel_Destination$] WHERE HospitalState='" + comboBox1.Text + "'AND HospitalCity ='" + comboBox2.Text + "'AND Diagnosis='" + comboBox3.Text + "'";
                dbcom = new OleDbCommand(str, dbcon);
                dbds = new DataSet();
                oledbdad = new OleDbDataAdapter(dbcom);
